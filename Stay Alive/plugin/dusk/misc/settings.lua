...
local data = {
	...
	furtherClassifyRectangleObjects = true,
	...
	-- erased, set this to a higher number as needed. Otherwise, a value of 1
	-- should be fine.
	cullingMargin = 1,
...
-- Set Preference
--------------------------------------------------------------------------------
function dusk_settings.set(preferenceName, value)
...
-- Get Preference
--------------------------------------------------------------------------------
function dusk_settings.get(preferenceName)
...
--------------------------------------------------------------------------------
function dusk_settings.setMathVariable(varName, value) data.mathVariables[varName] = value end
function dusk_settings.removeMathVariable(varName) data.mathVariables[varName] = nil end

return dusk_settings
...
function NewStick( Props )
    ...
    Group.x             = screenW/90 --Props.x -68
    Group.y             = screenH*0.847 --Props.y
    Group.Timer         = nil
    Group.angle         = 0
    Group.distance      = 0
    Group.percent       = 0
	...
	Group.Border = display.newImage("controller/joystickmain1a.png")
    Group.Border:scale( 0.6, 0.6 )
    Group.Border.alpha = 1.0
	...
	-- for use images uncomment the line down and comment line up
	Group.Thumb = display.newImage("controller/joystickmain1b.png")
    Group.Thumb:scale( 0.4, 0.4 )
    Group.Thumb.alpha = 1.0
